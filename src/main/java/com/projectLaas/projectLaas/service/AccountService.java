...
public class AccountService {
      ...
      public List<RegisterDTO> getAllUsers() {
            return accountRepository.findAll().stream()
                        .map(user -> new RegisterDTO(user.getId(), user.getName(), user.getEmail(), null,
                                    user.getRole()))
      ...
      public RegisterDTO updateUser(Long id, RegisterDTO updateDTO) {
            ...
            return new RegisterDTO(updatedUser.getId(), updatedUser.getName(), updatedUser.getEmail(), null,
                        updatedUser.getRole());
      }
      ...
      private RegisterDTO convertToDTO(User user) {
            return new RegisterDTO(user.getId(), user.getName(), user.getEmail(), user.getPassword(), user.getRole());
      }
}